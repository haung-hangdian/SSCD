...
# code ref: https://github.com/charlesCXK/TorchSemiSeg
...
class StepLR(BaseLR):
    def __init__(self, start_lr, total_iters):
        self.start_lr = start_lr
        self.total_iters = total_iters + 0.0
    ...
    def get_lr(self, cur_iter):
        if 2500 > cur_iter >= 0:
            return self.start_lr
        elif 5000 >= cur_iter >= 2500:
            return self.start_lr / 10
        else:
            return self.start_lr / 100
