...
parser.add_argument('--exp', type=str,
                    default='Cross_Teaching_cnn_Transformer', help='experiment_name')
...
def Inference_model1_with_confidence(FLAGS):
    ...
    # 定义路径
    snapshot_path = "/home/v1-4080s/hhy/ABD/model/ACDC/{}_{}_labeled/".format(FLAGS.exp, FLAGS.labeled_num)
    test_save_path = "/home/v1-4080s/hhy/ABD/model/ACDC/{}_{}_labeled/{}_predictions_model1/".format(FLAGS.exp, FLAGS.labeled_num, FLAGS.model_1)
    ...
    save_mode_path = os.path.join(snapshot_path, 'model1_iter_15800_dice_0.859.pth')
    ...
    # 保存结果到文件
    with open(os.path.join(test_save_path, 'performance_with_confidence_15800.txt'), 'w') as file:
...
def Inference_model1(FLAGS):
    ...
    with open(FLAGS.root_path + '/test.list', 'r') as f:
        image_list = f.readlines()
    image_list = sorted([item.replace('\n', '').split(".")[0] for item in image_list])
    snapshot_path = "/home/v1-4080s/hhy/ABD/model/ACDC/{}_{}_labeled/unet".format(FLAGS.exp, FLAGS.labeled_num)
    test_save_path = "/home/v1-4080s/hhy/ABD/model/ACDC/{}_{}_labeled/{}_predictions_model1/".format(FLAGS.exp, FLAGS.labeled_num, FLAGS.model_1)
...
def Inference_model2(FLAGS):
    ...
    image_list = sorted([item.replace('\n', '').split(".")[0]for item in image_list])
    snapshot_path = "/home/v1-4080s/hhy/ABD/model/ACDC/{}_{}_labeled/unet".format(FLAGS.exp, FLAGS.labeled_num)
    test_save_path = "/home/v1-4080s/hhy/ABD/model/ACDC/{}_{}_labeled/{}_predictions_model2/".format(FLAGS.exp, FLAGS.labeled_num, FLAGS.model_2)
    if not os.path.exists(test_save_path):
        os.makedirs(test_save_path)
