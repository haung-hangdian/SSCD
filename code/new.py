...
from utils.displacement import ABD_I_BCP, ABD_I_Conf,ABD_R_BS, BD_S_Unlabel, Ncut, Overlap
from dataloaders.dataset import (BaseDataSets, TwoStreamBatchSampler, WeakStrongAugment, BaseDataSetsnii)
from networks.net_factory import BCP_net, BCP_net_sdf
...
parser.add_argument('--root_path', type=str, default='/home/v1-4080s/hhy/ABD/data/MMWHS', help='Name of Experiment')
...
dice_loss = losses.DiceLoss(n_classes=8)
...
def patients_to_slices(dataset, patiens_num):
    ...
    #                 "12": 179, "16": 256, "21": 312, "42": 623}
        ...
        ref_dict = {"2": 27, "4": 145, "8": 288,
                    "12": 179, "16": 256, "42": 312, "48": 623, "96": 2700}
    else:
        print("Error")
...
def pre_train(args, snapshot_path):
    ...
    db_train = BaseDataSetsnii(base_dir=args.root_path,
                            split="train",
                            num=None,
                            transform=transforms.Compose([WeakStrongAugment(args.image_size)]))
    db_val = BaseDataSetsnii(base_dir=args.root_path, split="val")
    ...
    for _ in iterator:
        for _, sampled_batch in enumerate(trainloader):
            ...
            new_input = volume_batch[:args.labeled_bs]
            new_label = label_batch[:args.labeled_bs]
            ...
            new_outsoft = torch.softmax(new_out, dim=1)
            loss_dice = dice_loss(new_outsoft, new_label.unsqueeze(1))
            loss_ce = ce_loss(new_out, new_label.long())
...
def self_train(args ,pre_snapshot_path, snapshot_path):
    ...
    for _ in iterator:
        for _, sampled_batch in enumerate(trainloader):
            ...
            image_patch_last = Overlap(out_max_1, out_max_2, net_input_1, net_input_2, out_1, out_2, args)
...
if __name__ == "__main__":
    ...
    # -- path to save models
    pre_snapshot_path = "/home/v1-4080s/hhy/ABD/model/BCP/MMWHS_{}_{}_labeled/pre_train".format(args.exp, args.labelnum)
    self_snapshot_path = "/home/v1-4080s/hhy/ABD/model/BCP/MMWHS_{}_{}_labeled/self_train".format(args.exp, args.labelnum)
    for snapshot_path in [pre_snapshot_path, self_snapshot_path]:
        if not os.path.exists(snapshot_path):
            os.makedirs(snapshot_path)
    shutil.copy('/home/v1-4080s/hhy/ABD/code/new.py', self_snapshot_path)
